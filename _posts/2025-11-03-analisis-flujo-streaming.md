---
layout: post
title: "Análisis de Flujo de Datos Simulado con PySpark"
date: 2025-11-03
...
for minuto in range(1, 6):
    for u in usuarios:
        clicks_totales[u] += random.randint(1, 10)
    time.sleep(0.5)
...
plt.title("Clics Totales por Usuario (Simulación Streaming)")
plt.xlabel("Usuario ID")
plt.ylabel("Clics Totales")
plt.grid(axis='y', linestyle='--', alpha=0.6)
plt.tight_layout()
plt.savefig("assets/images/grafico_clicks.png")
plt.close()
